...
<div style="border:5px solid black; width:950px; height:900px;">
   ...
   <div Style="font-size:45px; margin-top:50px; color:red"><b>Court Management System for East Hararghe Zone</b></div>
   <img src="law.png" alt="logo" style="width:130px; height:130px; margin-bottom:15px;">
    <div style="color:blue; margin-bottom:10px; font-size:25px;"> <b>Expansion</b> <br>
...
<!--<form action="view_case_handler.php" method="POST"> 	-->
	...
	<table>
		<tr>
			<td><div style="float: left">Petition Number/Case Number/Review/Appeal:</div>
			</td>
		...
		<tr>
			<td><div style="float: left">name of petitioner:</div>
			</td>
		...
		<tr>
			<td>
				<div style="float: left">against:</div>
			</td>
		...
		<tr>
			<td>
					<div style="float: left">Name of officer in charge:</div>	
			</td>
		...
		<tr>
			<td>
					<div style="float: left">irradiance status:</div> 
			</td>
			<td>
		...
		<tr>
			<td>
				<div style="float: left">Other information:</div>
			</td>
