...
<div style="border:5px solid black; width:950px; height:950px;">
   ...
   <div Style="font-size:45px; margin-top:50px;"><b>Court Management System for East Hararghe Zone</b></div>
   ...
   <img src="logo.png" alt="logo" style="width:130px; height:130px; margin-bottom:15px;">
    <div style="color:blue; margin-bottom:10px; font-size:25px;"> <b>enter extension</b> <br>
	</div>
