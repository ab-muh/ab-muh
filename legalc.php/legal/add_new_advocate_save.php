...
//$query = "INSERT INTO Advocate VALUES ('{$_POST['case_year']}','{$_POST['case_type']}','$case_num','{$_POST['yachikakarta_name']}','{$_POST['versus']}','{$_POST['adhivakta_name']}','{$_POST['adhikari_name']}','$prakran','$prakran_date','$javabakarta_date','{$_POST['remarks']}','pending','','',0,'','','')";
$query = "INSERT INTO persons (name, last_name, email) VALUES ('Peter', 'Parker', 'peterparker@mail.com')";
echo $query;
